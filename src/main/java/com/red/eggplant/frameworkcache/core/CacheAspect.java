package com.red.eggplant.frameworkcache.core;
...
public class CacheAspect {
    ...
    private final String POINT_CUT = "execution(public * com.red.eggplant.frameworkcache.service.*.*(..))";
...
//            Class clazz = targetMethod.getClass();
            ...
            if(realMethod.isAnnotationPresent(Cache.class)){
                //获取方法上注解中表明的权限
                Cache cache = (Cache)realMethod.getAnnotation(Cache.class);
                String name = cache.cacheNames();
                if (StringUtils.isNotBlank(name)) {
                    RedisUtil.set(name, obj.toString());
                }
